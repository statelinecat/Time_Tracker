...
class TimeTrackerUI:
    ...
    def _set_window_icon(self, window):
        """Установить иконку для любого окна"""
        try:
            # Пробуем разные способы установки иконки
            icon_paths = ["app.ico", "app.png", "icon.ico", "icon.png"]
    ...
    def _setup_ui(self):
        ...
        # Кнопка "О программе"
        ttk.Button(top, text="О программе", command=self._show_about).pack(side=tk.LEFT, padx=5)
    ...
    def _show_about(self):
        ...
        # Заголовок
        ttk.Label(main_frame, text="Time Tracker",
                  font=("Arial", 16, "bold")).pack(pady=10)

        # Описание программы
        description_text = """
Учет времени, затраченного 
на различные задачи."""
        ...
        # Автор и версия
        ttk.Label(main_frame, text="Версия: 1.0",
                  font=("Arial", 9)).pack(pady=5)

        # ttk.Label(main_frame, text="Автор: stateline",
        #          font=("Arial", 9)).pack(pady=5)
        ...
        #ttk.Label(link_frame, text="Сайт: ",
        #          font=("Arial", 9)).pack(side=tk.LEFT)

        # Создаем кликабельную ссылку
        link_label = ttk.Label(link_frame, text="statelinecat.ru",
                               font=("Arial", 9, "underline"),
                               foreground="blue", cursor="hand2")
        link_label.pack(side=tk.LEFT)

        # Привязываем обработчик клика по ссылке
        link_label.bind("<Button-1>", lambda e: webbrowser.open("https://statelinecat.ru/"))
    ...
    def _show_report(self):
        ...
        # Устанавливаем иконку для окна отчета
        self._set_window_icon(report_window)
...
def main():
    ...
    # Установка иконку для главного окна
    icon_paths = ["app.ico", "app.png", "icon.ico", "icon.png"]
    icon_set = False
    ...
    if not icon_set:
        print("Не удалось установить иконку. Проверьте наличие файлов иконок")
